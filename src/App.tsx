...
import columbiaImg from "./imgs/columbia.png";
import secretWishImg from "./imgs/secretwish.png";
import americanTouristerImg from "./imgs/americantourister.png";
